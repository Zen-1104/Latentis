  ...
  return (
    <div data-testid={testId}>
      <svg
        ...
        role="img"
        aria-label="The typical shape of change over time for this group of parts. The table below lists the same values."
      >
      ...
      <div className="mt-3">
        <DataTable
          testId={`${testId}-table`}
          caption="The plotted curve, as values"
          columns={[
            { header: "Hours", numeric: true, rowHeader: true, render: (r) => formatPlain(r.t_hours, 1) },
            { header: "Share of total change", numeric: true, render: (r) => formatPlain(r.phi, 4) },
          ]}
          rows={points}
